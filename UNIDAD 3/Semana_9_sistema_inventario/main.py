...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            if cantidad < 0:
                print("No se puede registrar una cantidad negativa.")
                continue
            if precio < 0:
                print("No se puede registrar un precio negativo.")
                continue
            ...
            if inventario.anadir_producto(producto):
                ...
                print("Error: ese ID ya existe. No se añadió el producto.")

        elif opcion == "2":
            producto_id = input("Ingrese el ID a eliminar: ").strip()
            if inventario.eliminar_producto_por_id(producto_id):
            ...
            if inventario.actualizar_producto_por_id(producto_id, nueva_cantidad, nuevo_precio):
